...
class verifyPhoneScreen extends StatefulWidget {
  ...
  verifyPhoneScreen({this.verificationId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text('verify phone number',style: Theme.of(context).textTheme.bodySmall?.copyWith(
            color: Colors.black,
          ),),
        ),
      ),
      body: Padding(
        ...
        child: Column(
            ...
            children: [
              Text('code is sent to 0000000000',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                color: Colors.grey,
              ),),
              SizedBox(height: 40,),
              OTPTextField(
